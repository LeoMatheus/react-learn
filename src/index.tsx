...
function Footer() {
  ...
  // if (!isOpen) return <p>We are closed wait until we open at {openHour}:00</p>;
  ...
  return (
    <footer className="footer">
      {isOpen ? (
        ...
        <p>We are closed wait until we open at {openHour}:00</p>
      )}
    </footer>
  );
}

function Order({ closeHour }: any) {
  return (
    <div className="order">
